      ...
      <Container className={`mt-5 mb-5`}>
        <Row>
          <Col sm={12} md={6} id="about" className="text-left pr-5 pb-4 ">
            ...
            >
              E-Tech was founded on August 15 2020. Company purpose is to
        ...
        <Row className="text-center ">
          <Col md={12} lg={4}>
            <FeatureComponent
              ...
              even for that. Share your memes, thoughts, funny videos in your publication section...
          ...
          <Col md={12} lg={4}>
            <FeatureComponent
              ...
              text="All your homeworks will be available in one place. Imagine to have them in
        ...
        <Row className="text-center mt-4">
          <Col md={12} lg={4}>
            <FeatureComponent
              ...
              It's easier for the tutor or students to find projects in one place. Tutors can see student projects and the other way around."
            />
          </Col>
          ...
          <Col md={12} lg={4}>
            <FeatureComponent
              ...
              text="All users, students and tutors will have a brand new tool to communicate together.
              They can chat with each other privately or they will have the opportunity to chat in the general room.
          ...
          <Col md={12} lg={4}>
            <FeatureComponent
              ...
              text="Tutors can upload new books in different formats and can share with others.
